      ...
      <div className="p-10">
        ...
        <AnimationWrapper parentClass="flex pt-10 pb-20 justify-evenly sm:flex-wrap md:flex-no-wrap">
          <SponsorDescription
            ...
            parentClass="sm:w-full md:w-1/4 sm:mb-10 md:mb-0"
                ...
                {list.map(({ image }, index) => {
                  return (
                    <SponsorText
                      key={index}
                      image={image}
                      parentClass={`${title == 'Silver sponsors' ? 'sm:w-1/2 md:w-1/6 mb-10 text-center' : 'sm:w-1/2 md:w-1/4 mb-3 text-center'}`}
        ...
        <div>
          ...
          <AnimationWrapper parentClass="">
            <SponsorDescription
              imageClass="sponsor-img"
              descriptionClass=""
              innerClass="sm:w-full md:w-1/2 py-10"
              description={
