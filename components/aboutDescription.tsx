...
const AboutDescription = (props: AboutDescriptionProps) => {
  ...
  return (
    <div className={parentClass}>
      ...
      <p className="text-gray-300 font-medium text-xl sm:w-full mb-8">{firstDescription}</p>
      {secondDescription && <p className="text-gray-300 font-medium text-xl sm:w-full mb-8">{secondDescription}</p>}
